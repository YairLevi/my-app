...
function ToolbarSubContainer({ children }: PropsWithChildren) {
  return (
    <div className="items-center w-fit flex justify-evenly gap-1">
      {children}
    </div>
  )
}
...
function Toolbar() {
  ...
  return (
    <div className="flex bg-transparent border-b border-b-gray-700 min-h-fit items-center gap-1 p-1 py-2 overflow-y-hidden"
         onScroll={() => setop(!op)}>
      <ToolbarSubContainer>
        <RotateCcw
          className={clsx(
